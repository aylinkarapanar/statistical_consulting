...
# Save QQ plot
png("./Simulated Data/dharma_qq_plot.png", width = 3000, height = 2000, res = 500)
plotQQunif(sim_res)
dev.off()

# Save Residuals vs Predicted
png("./Simulated Data/dharma_residuals_vs_predicted.png", width = 3000, height = 2000, res = 500)
plotResiduals(sim_res)
dev.off()

# Save Dispersion test separately
png("./Simulated Data/dharma_dispersion_test.png", width = 3000, height = 2000, res = 500)
testDispersion(sim_res, plot = TRUE)
dev.off()

# Save Zero-inflation test separately
png("./Simulated Data/dharma_zeroinflation_test.png", width = 3000, height = 2000, res = 500)
...
replot_city$facet$params$labeller <- labeller(.default = function(x) gsub("_", " ", x))

replot_species <- sjPlot::plot_model(m_final, type = "re",
                              show.values = TRUE, 
                              value.offset = 0.3, 
                              value.size = 2.5, 
                              dot.size = 2,                
                              line.size = 0.7,
                              vline.color = 'black')[[3]] + theme_minimal()
replot_city
replot_species

ggsave(
  filename = "random_effects_city.png",
  plot     = replot_city,
  path = "./Simulated Data/",
  width    = 6,
  height   = 4,
...
ggsave(
  filename = "random_effects_species.png",
  plot     = replot_species,
  path = "./Simulated Data/",
  width    = 6,
  height   = 4,
...
```{r}
p <- sjPlot::plot_model(m_final, type = "est", transform = "exp", 
                axis.lim = c(0.8, 1.4),        
                show.values = TRUE,             
                value.offset = 0.3,            
                value.size = 2.5,               
  ...
  theme_minimal() + scale_color_manual(values = c("steelblue")) 

p   

ggsave(
  filename = "irr_plot.png",
  plot     = p,
  path = "./Simulated Data/",
  width    = 6,
  height   = 4,
